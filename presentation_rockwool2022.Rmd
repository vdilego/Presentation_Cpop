...
Technically, not a rate, but a measure of risk - by epidemiologists called Case-Fatality Risk. The CFR can be defined as the probability that a case dies from any given infection.
...
## The BIG issue of the CFR = the denominator <sup>1</sup>:

.pull-left-2[.content-box-blue[

- age-structure of detected cases

- age-structure of case-fatality rates
 
]]

$$CFR_i-CFR_j=\alpha+\delta   $$
the $CFR$ as the sum of age-specific $CFRs$ weighted by the proportion of cases in a certain age group

.pull-right-2[

- the age-structure of detected cases explained >60% of cross-country variation
- the age-structure of case-fatality rates within countries across time - nortality due to increasing age-specific case-fatality rates.
]



.pull-left-2[.footnote[[1] (Dudel C, Riffe T, Acosta E, van Raalte A, Strozza C, Myrskyla, M (2020))] ]
...
# What drives the patterns in the CFR?
